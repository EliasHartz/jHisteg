...
public class WhenFilesAreDistilled {
    ...
    @Test
    public void canCompileJava7() throws Exception {
        File left = CompilationUtils.getFile(TEST_DATA + "TestClass.java");
        File right = CompilationUtils.getFile(TEST_DATA + "TestClass_Modified.java");
        distiller.extractClassifiedSourceCodeChanges(left, right);
        assertThat(distiller.getSourceCodeChanges().size(), is(16));
    }
